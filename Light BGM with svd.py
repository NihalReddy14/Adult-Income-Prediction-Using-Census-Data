...
svd = TruncatedSVD(n_components=10)  # Choose an appropriate number of components
X_svd = svd.fit_transform(X)

# Dividing dataset into test and train
X_train, X_test, y_train, y_test = train_test_split(X_svd, y, test_size=0.3, random_state=0)
